...
if (isset($_SESSION['started_course']) && $_SESSION['started_course'] == 'html') {
    header("Location: start_course_html.php"); 
    exit;
}
?>
<body>
    ...
    <div class="content container mt-6">
        ...
        <p>
            HTML (Hypertext Markup Language) on verkkosivujen rakenteen kieli ja tyyliohjeiden kieli, jota käytetään verkkosivujen ulkoasun määrittämiseen. HTML-koulutuksessa
                ...
                <div class="col-md-5">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <form method="POST" action="login.php?redirect=htmlkoulutus.php">
                            <div class="mb-3">

...
if (isset($_SESSION['started_course']) && $_SESSION['started_course'] == 'mysql') {
    header("Location: start_course_mysql.php"); 
    exit;
}
?>
<body>
                ...
                <div class="col-md-5">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <form method="POST" action="login.php?redirect=mysqlkoulutus.php">
                            <div class="mb-3">
